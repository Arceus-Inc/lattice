...
def test_public_exports() -> None:
    ...
    assert hasattr(lattice, "ReplayOutcome")
    assert hasattr(lattice, "ReplayResult")
    assert hasattr(lattice, "ReplaySeverity")
    assert hasattr(lattice, "RepresentativeSuccessEvidence")
